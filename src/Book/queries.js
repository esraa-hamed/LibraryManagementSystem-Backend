...
const checkBook = "SELECT * FROM borrowingdetails WHERE ISBN = $1 ";
const deleteBFromBorrowingDetails = "DELETE FROM borrowingdetails WHERE ISBN = $1";
